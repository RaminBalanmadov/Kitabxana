...
package com.addkitabxanastudent.model;

public class NowLoginStudentDB {
    ...
    public NowLoginStudentDB() {
    }

    
    public NowLoginStudentDB(String name, String surname, String tbSeriaNumber) {
        this.name = name;
    ...
    public NowLoginStudentDB(String yaziciName, String bookName) {
